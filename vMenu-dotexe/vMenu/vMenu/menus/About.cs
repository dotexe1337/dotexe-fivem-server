...
namespace vMenuClient
{
    public class About
    {
        ...
        private void CreateMenu()
        {
            ...
            MenuItem credits = new MenuItem("About vMenu", "vMenu is made by ~b~Vespura~s~. This version has been modified by ~b~dotexe~s~ for his drift server. For more information, please view: www.github.com/dotexe1337/dotexe-fivem-server");
